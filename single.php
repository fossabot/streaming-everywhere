<?php /* The template for displaying all Movie posts. */ get_header();?>
      ...
      <div class="uk-grid">
         ...
         <div class="uk-width-medium-7-10">
            ...
            <ul id="media-tabs" class="uk-switcher">
               <li>
                  ...
                  <ul class="uk-subnav uk-subnav-line">
                     <li>
                        ...
                        <?php echo get_post_meta(get_the_ID(), '_rating_point', true);?>
                     </li>
                     <li>
                        ...
                        <?php echo get_post_meta(get_the_ID(),'_movie_duration',true);?>
                     </li>
                     <li>
                        ...
                        <?php echo get_post_meta(get_the_ID(), '_movie_date', true);?> 
                     </li>
                  </ul>
                  <hr>
                  ...
                  <dl class="uk-description-list-horizontal uk-margin-top">
                     ...
                     <dd>
                        <ul class="uk-subnav">
                           <?php $strings = get_post_meta(get_the_ID(), '_movie_starring', true);$array1 = explode (',', $strings);foreach($array1 as $item):?>
                           <li><?php echo $item; ?></li>
                           <?php endforeach; ?>
                        </ul>
                     </dd>
                     ...
                     <dd>
                        <ul class="uk-subnav">
                           <?php $genar1 = get_post_meta(get_the_ID(),'_movie_genres', true);$genars = explode (',', $genar1);foreach ($genars as $genar) : ?>
                     ...
                     <dd>
                        <ul class="uk-subnav">
                           <?php $lang1 = get_post_meta(get_the_ID(), '_movie_languages', true);$langs = explode(',', $lang1);foreach($langs as $lang) : ?>
                           <li><?php echo $lang; ?></li>
                           <?php endforeach; ?>
                        </ul>
                     </dd>
               ...
               <li>
                  <div class="uk-margin-top uk-cover" style= "width:100%;height:400px;">
